...
public class payload {
    ...
    public com.btpltech.bankingbot.Model.confirmation getConfirmation() {
        return confirmation;
    }

    public void setConfirmation(com.btpltech.bankingbot.Model.confirmation confirmation) {
        this.confirmation = confirmation;
    }

    public ArrayList<com.btpltech.bankingbot.Model.list> getList() {
        return list;
    }

    public void setList(ArrayList<com.btpltech.bankingbot.Model.list> list) {
        this.list = list;
    }
